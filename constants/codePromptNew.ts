...
const limitedMarkdownPlugin: Plugin = () => {
  return (tree: any, file: { toString: () => any; }) => {
...
<artifact_instructions>
  ...
  CRITICAL FILE RESTRICTIONS:
    ...
    - Use index.html as the main HTML file
    - Always use relevent icons from Lucide React only
    - Use Tailwind CSS for styling not any other CSS frameworks
    - Use only styles.css as the main CSS file and always import it at index.js 'import "./styles.css";'
    - Never use src folder
    - Always use App.js and index.js for React applications and at root level no need to create src folder
...
<boltAction type="file" filePath="App.js" contentType="content">import React from 'react';
import './styles.css';
...
<boltAction type="file" filePath="styles.css" contentType="content">.container {
  max-width: 800px;
  margin: 0 auto;
  padding: 20px;
...
<boltAction type="file" filePath="index.js" contentType="content">import React from 'react';
